...
# gem_mine Rakefile v7.1.11 - 2026-08-29
...
# rake install                                # Build and install gem_mine-1.0.0.gem in...
# rake install:local                          # Build and install gem_mine-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template gem_mine against itse...
